...
import MenuLOptionType from "@/components/menu/items/l_option/MenuLOptionType.vue";
import MenuLOptionProgress from "@/components/menu/items/l_option/MenuLOptionProgress.vue";
import MenuLOptionWeather from "@/components/menu/items/l_option/MenuLOptionWeather.vue";
import MenuLOptionEnv from "@/components/menu/items/l_option/MenuLOptionEnv.vue"
export default {
  name: "MenuView",
  components: {
    MenuMain,
